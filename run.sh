...
#   GITHUB_USERNAME - Name of the github user, e.g. SDcodehub
#   IS_PUBLIC_REPO - if true the repository will public else private
function create-repo-if-not-exists {
    local IS_PUBLIC_REPO=${IS_PUBLIC_REPO:-false}
    # Check of repo exists ; if does return
